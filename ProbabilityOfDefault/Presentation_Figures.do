...
graph export "$rpath/CDS_Plot.png", replace
...
graph export "$rpath/Recovery_Plot.png", replace
...
graph export "$rpath/Hazard_Plot.png", replace
...
graph export "$rpath/Default_Plot.png", replace
...
graph export "$rpath/Default_Plot2.png", replace
